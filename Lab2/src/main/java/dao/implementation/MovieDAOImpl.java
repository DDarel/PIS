...
public class MovieDAOImpl implements MovieDAO {
    ...
    public MovieDAOImpl() throws SQLException, ClassNotFoundException {
    }
    ...
    public Movie get(int id) throws SQLException {
        ...
        Movie movie = null;
        String sql = "SELECT movie_id, movie_name, movie_duration, movie_director, movie_poster_path, movie_rent_start, movie_rent_end FROM localcinema.movies WHERE movie_id = ?";
    ...
    public List<Movie> getAll() throws SQLException {
        ...
        Movie movie = null;
        String sql = "SELECT movie_id, movie_name, movie_duration, movie_director, movie_poster_path, movie_rent_start, movie_rent_end FROM localcinema.movies";
        PreparedStatement ps = con.prepareStatement(sql);
        ResultSet rs = ps.executeQuery();
        if(rs.next()){
            int movieId = rs.getInt("movie_id");
